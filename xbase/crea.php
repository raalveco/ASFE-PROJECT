...
<body style="background-color:#666666; font-size:11px; font-family:Arial, Helvetica, sans-serif;">
...
<table width="1050" border="0" align="center" cellpadding="0" cellspacing="0" background="imgs/center_1050.png">
  <tr>
    <td width="98%"><table width="98%" border="0" align="center">
      <tr>
        <td width="548" bgcolor="#0087BD" style="color:#FFFFFF;">Script de Facturación Electrónica CFD V2.2 (julio 2012)</td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">
		<form id="form1" name="form1" method="post" action="crea_cfd.php">
            <table width="99%%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
				...
				<br /><div  style="color:#000066; font-size:24px; font-family:Arial, Helvetica, sans-serif;">Datos del CFD</div></td>
              </tr>
              <tr>
                ...
                <td colspan="2" align="center" bgcolor="#E6E6E6"><strong>* Aprobación </strong></td>
                </tr>
              <tr>
                <td width="17%" bgcolor="#EAEFFF" align="center">
				<input name="forma_pago" type="text" id="forma_pago" value="Pago en una sola exhibición" size="25" maxlength="50" />
				</td>
                <td width="30%" bgcolor="#EAEFFF" align="center"><select name="tipo_cfd" id="tipo_cfd">
                  <option value="ingreso" selected="selected">ingreso</option>
                  <option value="egreso">egreso</option>
                  <option value="traslado">traslado</option>
                </select>
				</td>
                <td width="25%" bgcolor="#EAEFFF" align="center">
				<input name="fecha" type="text" id="fecha" 
					<?php
						 echo 'value="'.date("Y-m-d").'T'.date("H:i:s").'"';						 
					?>
				size="22" maxlength="10" /></td>
                <td colspan="2" align="center" bgcolor="#EAEFFF">Certificado: 
...
<input name="year_aprobacion" type="text" id="year_aprobacion" value="2010" size="4" maxlength="10" /></td>
              ...
              <tr>
                ...
                <td width="10%" align="center" bgcolor="#E6E6E6"><strong>* IVA en % </strong></td>
                <td width="18%" align="center" bgcolor="#E6E6E6"><strong>* Método de Pago</strong></td>
                </tr>
              <tr>
                ...
                <td align="center" bgcolor="#EAEFFF"><input name="iva" type="text" id="iva" value="16" size="6" maxlength="3" /></td>
                <td align="center" bgcolor="#EAEFFF"><select name="metodo_pago" id="metodo_pago">
                  <option value="Transferencia" selected="selected">Transferencia</option>
                  <option value="Cheque">Cheque</option>
                  <option value="Efectivo">Efectivo</option>
                  <option value="Indenido">Indefinido</option>
                </select></td>
                </tr>
              <tr>
                <td colspan="2" align="center" bgcolor="#FFFFFF"><strong>* Régimen Fiscal del Emisor</strong></td>
                <td colspan="2" align="center" bgcolor="#FFFFFF"><strong>* Lugar de Expedición</strong></td>
                <td bgcolor="#FFFFFF" align="center">&nbsp;</td>
              </tr>
              <tr>
                <td colspan="2" align="center" bgcolor="#FFFFFF"><input type="text" name="regimen_emisor" id="regimen_emisor" value="Régimen General de Ley Personas Morales" size="50" /></td>
                <td colspan="2" align="center" bgcolor="#FFFFFF"><input type="text" name="lugar_expedicion" id="lugar_expedicion" value="México DF" /></td>
                <td bgcolor="#FFFFFF" align="center">&nbsp;</td>
              </tr>
              <tr>
				...
				<br />
				<div  style="color:#000066; font-size:24px; font-family:Arial, Helvetica, sans-serif;">
				Datos del Receptor</div>
              ...
              <tr>
                <td colspan="5" bgcolor="#FFFFFF">
					...
					<tr>
					  <td bgcolor="#EAEFFF" align="center"><input name="rfc" type="text" id="rfc" value="CAUR390312S87" size="25" maxlength="60" /></td>
					  <td colspan="4" align="left" bgcolor="#EAEFFF"> 
					    <input name="razon_social" type="text" id="razon_social" value="Rosa María Calderón Uriegas" size="90" maxlength="128" />
					   </td>
					  </tr>
					<tr>
					  ...
					  <tr>
						<td bgcolor="#EAEFFF" align="center">
							<input name="calle" type="text" id="calle" value="Topochico" size="25" maxlength="60" />						</td>
						<td bgcolor="#EAEFFF" align="center">
						...
						<td bgcolor="#EAEFFF" align="center">
						  <input name="localidad" type="text" id="localidad" value="Monterrey" size="30" maxlength="45" />						</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td bgcolor="#EAEFFF" align="center">
							<input name="municipio" type="text" id="municipio" value="Monterrey" size="25" maxlength="50" />						</td>
						<td bgcolor="#EAEFFF" align="center">
				        ...
				        <td align="center" bgcolor="#EAEFFF"><input name="referencia" type="text" id="referencia" size="30" maxlength="45" /></td>
					  </tr>
					  <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td width="68%" bgcolor="#EAEFFF"><input name="d1" type="text" id="d1" value="Vasos decorados" size="80" maxlength="128" />                </td>
                <td width="9%" bgcolor="#EAEFFF">
                    <input name="precio1" type="text" id="precio1" value="20" size="10" maxlength="15" /></td>
              ...
              <tr>
                ...
                <td bgcolor="#EAEFFF">                  <input name="d2" type="text" id="d2" value="Charola metálica" size="80" maxlength="128" />                </td>
                <td bgcolor="#EAEFFF">                  <input name="precio2" type="text" id="precio2" value="150" size="10" maxlength="15" />                </td>
              ...
              <tr>
                ...
                <td bgcolor="#EAEFFF">                  <input name="d3" type="text" id="d3" size="80" maxlength="128" />                </td>
                <td bgcolor="#EAEFFF">                  <input name="precio3" type="text" id="precio3" size="10" maxlength="15" />                </td>
              ...
              <tr>
                ...
                <td bgcolor="#EAEFFF">                  <input name="d4" type="text" id="d4" size="80" maxlength="128" />                </td>
                <td bgcolor="#EAEFFF">                  <input name="precio4" type="text" id="precio4" size="10" maxlength="15" />                </td>
              ...
              <tr>
                ...
                <td bgcolor="#EAEFFF">                  <input name="d5" type="text" id="d5" size="80" maxlength="128" />                </td>
                <td bgcolor="#EAEFFF">                  <input name="precio5" type="text" id="precio5" size="10" maxlength="15" />                </td>
